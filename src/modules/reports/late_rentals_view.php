        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <?php if (empty($late_payments)): ?>
                    <tr><td colspan="9" class="text-center alert alert-success">لا توجد دفعات إيجار متأخرة.</td></tr>
                <?php else: ?>
                    <?php foreach ($late_payments as $payment): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($payment['unit_names']); ?></td>
