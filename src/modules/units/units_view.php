<?php
// =================================================================
// ملف عرض الوحدات (units_view.php) - النسخة النهائية المطابقة للتصميم الأصلي 100%
// =================================================================
...
// =================================================================
// 2. بناء الاستعلام بشكل ديناميكي
// =================================================================
$sql_from_joins = "
    FROM units u
    LEFT JOIN properties p ON u.property_id = p.id
    LEFT JOIN contract_units cu ON u.id = cu.unit_id
...
if (!empty($filter_property_id)) {
    $sql_where .= " AND u.property_id = ? ";
    $params[] = $filter_property_id;
}
if (!empty($filter_unit_type)) {
    $sql_where .= " AND u.unit_type = ? ";
    $params[] = $filter_unit_type;
}
